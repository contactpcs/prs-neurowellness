...
// Same shape as doctor/patients/[id]/assessment/[permissionId]/page.tsx —
// this codebase duplicates the assessment-taking page per role rather than
// sharing it (matches the patient-role copy too); the only real differences
// here are the redirect target and dropping the ?session= visit-toggle
// forwarding, which is a doctor-portal-only concept.
...
export default function ClinicalAssistantOnBehalfAssessmentPage() {
  ...
  }, [currentScale, responses, completedScaleIds, isLastScale, scales, patientId, router]); // eslint-disable-line react-hooks/exhaustive-deps
